...
// Marketing landing page (shell for #69). Establishes the design-system-v2
// rhythm — alternating greige and near-black sections — and hosts the
// scroll-aware header (#66). Section reveal (#67), parallax (#68) and the full
// content pass land on top of this scaffold.
    ...
    <div id="top" className="min-h-svh bg-background">
      ...
      <section className="mx-auto flex min-h-svh max-w-6xl flex-col justify-center px-6 pb-24 pt-32">
        ...
        <p className="mt-8 max-w-xl text-lg text-muted-foreground">
          Müştəri masadakı QR kodu skan edir, hesabı görür, bölür, bəxşiş əlavə
          edir və saniyələr içində ödəyir.
        </p>
...
function Feature({
  ...
  return (
    <div>
      <div className={dark ? 'mb-5 text-brand-green' : 'mb-5 text-foreground'}>
        {icon}
      </div>
      <h3 className="text-lg font-medium">{title}</h3>
      <p className={dark ? 'mt-2 text-white/60' : 'mt-2 text-muted-foreground'}>
        {body}
      </p>
    </div>
  )
